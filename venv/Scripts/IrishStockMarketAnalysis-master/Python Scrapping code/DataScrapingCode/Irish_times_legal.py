...
csv_file= open('Irish_times_legal.csv' , 'w')
csv_writer= csv.writer(csv_file)
csv_writer.writerow(['Name','Date','Headline','Description','Body'])
share_list=['discrimination+laws','antitrust+laws','consumer+protection+laws','copyright+and+patent+laws','copyright+patent+laws','health+and+safety+laws']
for shares in share_list:
    shares=shares
    try:
        source= requests.get('https://www.irishtimes.com/search/search-7.4195619?q='+shares+'+market&fromDate=01%2F01%2F2014&toDate=24%2F10%2F2019&page=0').text
        #print(source)
