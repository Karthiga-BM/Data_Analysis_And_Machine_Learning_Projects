...
csv_file= open('Irish_times_technology.csv' , 'w')
csv_writer= csv.writer(csv_file)
csv_writer.writerow(['Name','Date','Headline','Description','Body'])
share_list=['Technology+incentives','level+of+innovation','automation','Research+development','technological+change','technological+awarness']
