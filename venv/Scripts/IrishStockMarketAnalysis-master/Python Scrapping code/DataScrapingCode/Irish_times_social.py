...
csv_file= open('Irish_times_social.csv' , 'w')
csv_writer= csv.writer(csv_file)
csv_writer.writerow(['Name','Date','Headline','Description','Body'])
share_list=['Population+growth+rate','age+distribution','career+attitutes','safety+emphasis','health+consciousness','lifestyle+attitudes','cultural+barriers']
