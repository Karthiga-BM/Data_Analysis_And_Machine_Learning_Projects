...
logging.basicConfig(handlers=[logging.FileHandler('Modelling_Random_Forest(5_cross_validation_and_BOW)_log.txt','w', 'utf-8')], level=logging.INFO,
...
if __name__ == "__main__":
    ...
    for number_of_features in [100,500,1000,5000,8000]:
        logging.info("-----------------------------TRAINING Random Forest MODELS WITH {} FEATURES -----------------------------------\n".format(
            number_of_features))
